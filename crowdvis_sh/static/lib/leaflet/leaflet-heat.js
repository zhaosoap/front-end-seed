    ...
    _colorize: function (pixels, gradient) {
        for (var i = 3, len = pixels.length, j; i < len; i += 4) {
            ...
            if (j) {
                ...
                pixels[i] = Math.min(255*this.defaultOpacity,pixels[i]);
            }
    ...
    */
    ...
    _redraw: function () {
        ...
        var data = [],
            ...
            // cellNum default is 2 previously
            v = 1 / (Math.pow(2, 14)*zoomMap[this._map.getZoom()]),
            cellSize = r/2,
        ...
        //console.log("Number of Points: " + this._latlngs.length +'\n');
    ...
    _animateZoom: function (e) {
        ...
        // Change radius
        var zoom = e.zoom;
		var new_r = this.radius*Math.pow(1.3,zoom-11);
        new_r = Math.min(60, new_r);
        new_r = Math.max(5, new_r);
        this._heat.updateCircle(new_r);
